...
sub do_figueiredo
{
   ...
   $cplex_env->setdblparam(&Math::CPLEX::Base::CPX_PARAM_SOLNPOOLGAP,   1e-3);
   $cplex_env->setdblparam(&Math::CPLEX::Base::CPX_PARAM_SOLNPOOLAGAP,  1e-3);
