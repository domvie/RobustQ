...
ok( $lp->getcolindex('c1') == 0, "get column index");
ok( $lp->getcolindex('c3') == 2, "get column index");
...
ok( $lp->getrowindex('row1') == 0, "get row index");
ok( $lp->getrowindex('row3') == 2, "get row index");
################################################################################
...
################################################################################
################################################################################
my $method = &Math::CPLEX::Base::CPX_ALG_NONE;
ok( $lp->presolve($method), "testing presolve() method for MIP");
################################################################################
